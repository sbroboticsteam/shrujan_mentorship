...
Polygon poly_6b =
    drawPoly(allpoints: location_6b, color: Colors.blue, id: '6b');
...
Polygon poly_11 =
    drawPoly(allpoints: location_11, color: Colors.blue, id: '11');
...
Polygon poly_13 =
    drawPoly(allpoints: location_13, color: Colors.blue, id: '13');
...
Polygon poly_13a =
    drawPoly(allpoints: location_13a, color: Colors.blue, id: '13a');
...
Polygon poly_14a =
    drawPoly(allpoints: location_14a, color: Colors.blue, id: '14a');
...
Polygon poly_14b =
    drawPoly(allpoints: location_14b, color: Colors.blue, id: '14b');
...
Polygon poly_16 =
    drawPoly(allpoints: location_16, color: Colors.blue, id: '16');
...
Polygon poly_18 =
    drawPoly(allpoints: location_18, color: Colors.blue, id: '18');
...
Polygon poly_22 =
    drawPoly(allpoints: location_22, color: Colors.blue, id: '22');
...
Polygon poly_24 =
    drawPoly(allpoints: location_24, color: Colors.blue, id: '24');
...
Polygon poly_31 =
    drawPoly(allpoints: location_31, color: Colors.blue, id: '31');
...
Polygon poly_32 =
    drawPoly(allpoints: location_32, color: Colors.blue, id: '32');
...
Polygon poly_33 =
    drawPoly(allpoints: location_33, color: Colors.blue, id: '33');
...
List<LatLng> location_34 = [
  const LatLng(0.906437, -73.119172),
...
Polygon poly_34 =
    drawPoly(allpoints: location_34, color: Colors.blue, id: '34');
...
Polygon poly_35 =
    drawPoly(allpoints: location_35, color: Colors.blue, id: '35');
...
Polygon poly_37 =
    drawPoly(allpoints: location_37, color: Colors.blue, id: '37');
...
Polygon poly_37b =
    drawPoly(allpoints: location_37b, color: Colors.blue, id: '37b');
...
Polygon poly_40 =
    drawPoly(allpoints: location_40, color: Colors.blue, id: '40');
